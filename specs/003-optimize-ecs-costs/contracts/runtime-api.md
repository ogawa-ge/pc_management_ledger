...
| 契約 | 対応要件 |
|---|---|
| 状態変更3ルートと非永続`parse-specs`の分類 | FR-009, FR-010, FR-010a, FR-010b |
| `503 starting`、`Retry-After`、最大180秒再送 | FR-006, FR-007, FR-008 |
| `409 processing`、7日保持、5分回収、旧所有者拒否 | FR-009, FR-010, FR-010a, FR-010b |
| 起動所有権と共有起動状態 | FR-011, FR-012 |
| 受付・処理中・成功完了の活動追跡 | FR-013, FR-014, FR-015, FR-016 |
| 内部署名、±60秒、既存認証併用 | FR-004a |
| 現行・次期の最大2世代ローテーション | FR-004b |
